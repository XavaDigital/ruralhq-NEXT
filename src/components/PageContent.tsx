...
export function Prose({ children }: { children: ReactNode }) {
  return (
    <div className="container-rhq py-12">
      <div className="mx-auto max-w-3xl leading-relaxed text-body [&_a]:text-brand-dark [&_a]:underline [&_h2]:mb-2 [&_h2]:mt-8 [&_h2]:font-slab [&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-ink [&_li]:mt-1 [&_p]:mt-3 [&_ul]:mt-3 [&_ul]:list-disc [&_ul]:pl-6">
        {children}
      </div>
    </div>
  );
